...
export const MISSION_CARDS: MissionCard[] = [
  // ── Easy (1–13) ────────────────────────────────────────────────────────────
  {
    id: 1, tier: 'easy', objectiveType: 'cash_gte', params: { target: 500 }, reward: 100,
  ...
  {
    id: 2, tier: 'easy', objectiveType: 'total_sold_units', params: { target: 10 }, reward: 125,
  ...
  {
    id: 3, tier: 'easy', objectiveType: 'cities_visited', params: { target: 3 }, reward: 150,
    title: 'Local Color',
  ...
  {
    id: 4, tier: 'easy', objectiveType: 'heat_at_most', params: { target: 20 }, reward: 125,
    title: 'Laid Low',
  ...
  {
    id: 5, tier: 'easy', objectiveType: 'cargo_units_of_type_gte', params: { target: 5, alcoholType: 'beer' }, reward: 100,
  ...
  {
    id: 6, tier: 'easy', objectiveType: 'turns_without_arrest', params: { target: 5 }, reward: 150,
    title: 'Steady Hand',
  ...
  {
    id: 7, tier: 'easy', objectiveType: 'sold_units_of_type', params: { target: 8, alcoholType: 'beer' }, reward: 150,
  ...
  {
    id: 8, tier: 'easy', objectiveType: 'officials_bribed', params: { target: 1 }, reward: 100,
    title: 'Two-Bit Bribe',
  ...
  {
    id: 9, tier: 'easy', objectiveType: 'total_cargo_units_gte', params: { target: 12 }, reward: 150,
    title: 'Produce Wagon',
  ...
  {
    id: 10, tier: 'easy', objectiveType: 'cities_owned_gte', params: { target: 1 }, reward: 125,
    title: 'Home Turf',
  ...
  {
    id: 11, tier: 'easy', objectiveType: 'cargo_units_of_type_gte', params: { target: 5, alcoholType: 'moonshine' }, reward: 100,
    title: 'Mountain Dew',
  ...
  {
    id: 12, tier: 'easy', objectiveType: 'distillery_tier_gte', params: { target: 2 }, reward: 200,
  ...
  {
    id: 13, tier: 'easy', objectiveType: 'total_cash_earned', params: { target: 300 }, reward: 275,
  ...
  // ── Medium (14–26) ──────────────────────────────────────────────────────────
  {
    id: 14, tier: 'medium', objectiveType: 'cash_gte', params: { target: 3000 }, reward: 425,
    title: 'War Chest',
  ...
  {
    id: 15, tier: 'medium', objectiveType: 'cities_owned_gte', params: { target: 3 }, reward: 525,
  ...
  {
    id: 16, tier: 'medium', objectiveType: 'cities_visited', params: { target: 7 }, reward: 425,
    title: 'Route Man',
  ...
  {
    id: 17, tier: 'medium', objectiveType: 'total_sold_units', params: { target: 40 }, reward: 625,
  ...
  {
    id: 18, tier: 'medium', objectiveType: 'heat_at_most', params: { target: 10 }, reward: 525,
    title: 'Under Wraps',
  ...
  {
    id: 19, tier: 'medium', objectiveType: 'sold_units_of_type', params: { target: 20, alcoholType: 'gin' }, reward: 425,
  ...
  {
    id: 20, tier: 'medium', objectiveType: 'turns_without_arrest', params: { target: 10 }, reward: 700,
    title: 'Clean Streak',
  ...
  {
    id: 21, tier: 'medium', objectiveType: 'officials_bribed', params: { target: 3 }, reward: 425,
  ...
  {
    id: 22, tier: 'medium', objectiveType: 'vehicles_owned_gte', params: { target: 2 }, reward: 525,
    title: 'Fleet Manager',
  ...
  {
    id: 23, tier: 'medium', objectiveType: 'distillery_tier_gte', params: { target: 3 }, reward: 625,
    title: 'Aging Tanks',
  ...
  {
    id: 24, tier: 'medium', objectiveType: 'cargo_units_of_type_gte', params: { target: 15, alcoholType: 'whiskey' }, reward: 525,
    title: 'Canadian Gold',
  ...
  {
    id: 25, tier: 'medium', objectiveType: 'sabotages_completed', params: { target: 1 }, reward: 425,
  ...
  {
    id: 26, tier: 'medium', objectiveType: 'total_cash_earned', params: { target: 2000 }, reward: 850,
  ...
  // ── Hard (27–39) ────────────────────────────────────────────────────────────
  {
    id: 27, tier: 'hard', objectiveType: 'cash_gte', params: { target: 8000 }, reward: 1050,
    title: 'Deep Pockets',
  ...
  {
    id: 28, tier: 'hard', objectiveType: 'cities_owned_gte', params: { target: 5 }, reward: 1250,
    title: 'Territorial',
  ...
  {
    id: 29, tier: 'hard', objectiveType: 'cities_visited', params: { target: 12 }, reward: 1050,
    title: 'The Long Haul',
  ...
  {
    id: 30, tier: 'hard', objectiveType: 'total_sold_units', params: { target: 100 }, reward: 1400,
    title: 'Moving Units',
  ...
  {
    id: 31, tier: 'hard', objectiveType: 'heat_at_most', params: { target: 5 }, reward: 1250,
    title: 'The Ghost',
  ...
  {
    id: 32, tier: 'hard', objectiveType: 'sold_units_of_type', params: { target: 50, alcoholType: 'rum' }, reward: 1125,
    title: 'Rum Row',
  ...
  {
    id: 33, tier: 'hard', objectiveType: 'turns_without_arrest', params: { target: 20 }, reward: 1750,
    title: 'Untouchable',
  ...
  {
    id: 34, tier: 'hard', objectiveType: 'officials_bribed', params: { target: 6 }, reward: 1050,
    title: 'The Fixers',
  ...
  {
    id: 35, tier: 'hard', objectiveType: 'vehicles_owned_gte', params: { target: 3 }, reward: 1125,
    title: 'Motorpool',
  ...
  {
    id: 36, tier: 'hard', objectiveType: 'distillery_tier_gte', params: { target: 4 }, reward: 1400,
  ...
  {
    id: 37, tier: 'hard', objectiveType: 'cargo_units_of_type_gte', params: { target: 20, alcoholType: 'scotch' }, reward: 1250,
  ...
  {
    id: 38, tier: 'hard', objectiveType: 'sabotages_completed', params: { target: 3 }, reward: 1050,
    title: 'Wrecking Crew',
  ...
  {
    id: 39, tier: 'hard', objectiveType: 'total_cash_earned', params: { target: 8000 }, reward: 1750,
    title: 'Big League',
  ...
  // ── Legendary (40–52) ───────────────────────────────────────────────────────
  {
    id: 40, tier: 'legendary', objectiveType: 'cash_gte', params: { target: 15000 }, reward: 2100,
    title: 'Millionaire',
  ...
  {
    id: 41, tier: 'legendary', objectiveType: 'cities_owned_gte', params: { target: 8 }, reward: 2450,
    title: 'Sovereign',
  ...
  {
    id: 42, tier: 'legendary', objectiveType: 'cities_visited', params: { target: 18 }, reward: 2100,
    title: 'Cartographer',
  ...
  {
    id: 43, tier: 'legendary', objectiveType: 'total_sold_units', params: { target: 200 }, reward: 2800,
    title: 'Volume King',
  ...
  {
    id: 44, tier: 'legendary', objectiveType: 'heat_at_most', params: { target: 2 }, reward: 3150,
  ...
  {
    id: 45, tier: 'legendary', objectiveType: 'sold_units_of_type', params: { target: 100, alcoholType: 'bourbon' }, reward: 2450,
  ...
  {
    id: 46, tier: 'legendary', objectiveType: 'turns_without_arrest', params: { target: 35 }, reward: 3150,
    title: 'Legend',
  ...
  {
    id: 47, tier: 'legendary', objectiveType: 'officials_bribed', params: { target: 10 }, reward: 2450,
    title: 'The Network',
  ...
  {
    id: 48, tier: 'legendary', objectiveType: 'vehicles_owned_gte', params: { target: 4 }, reward: 2100,
    title: 'Master Fleet',
  ...
  {
    id: 49, tier: 'legendary', objectiveType: 'distillery_tier_gte', params: { target: 5 }, reward: 2800,
  ...
  {
    id: 50, tier: 'legendary', objectiveType: 'sabotages_completed', params: { target: 6 }, reward: 2450,
  ...
  {
    id: 51, tier: 'legendary', objectiveType: 'total_cargo_units_gte', params: { target: 40 }, reward: 2100,
    title: 'The Full Load',
  ...
  {
    id: 52, tier: 'legendary', objectiveType: 'total_cash_earned', params: { target: 20000 }, reward: 3150,
    title: 'Kingpin',
